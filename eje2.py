...
# “El resultado de la suma es [suma]”, donde “[suma]” se reemplazará por el resultado de la operación.
def run():
    ndecimal= float(input("Ingrese un numero decimal: "))
    nentero= int(input("Ingrese un numero entero: "))
