...
#tendrá que ser un número entre 0 y 4) 
...
def run():
    ...
    ccaracteres=len(texto)
    print("Ingrese un numero positivo menor a ", ccaracteres,": ")
    indice=int(input())
    print("El caracter en esa posicion es: ",texto[indice])    
